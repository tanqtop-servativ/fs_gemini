...
CREATE OR REPLACE FUNCTION public.create_property_safe(
    ...
    p_bathroom_sinks integer, -- NEW
    p_bath_mats integer,      -- NEW
...
BEGIN
    ...
    VALUES (
        ...
        p_bathroom_sinks, p_bath_mats -- NEW
    )
...
BEGIN
    ...
    SET name = p_name, display_address = p_address, hcp_customer_id = p_hcp_cust, hcp_address_id = p_hcp_addr, 
        ...
        bathroom_sinks = p_bathroom_sinks, bath_mats = p_bath_mats -- NEW
    WHERE id = p_id;
