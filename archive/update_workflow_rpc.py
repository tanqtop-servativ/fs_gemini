...
def update_rpc():
    try:
        ...
        print("Updating generate_service_workflow RPC...")
        cur.execute("""
            ...
            BEGIN
                ...
                IF v_bom_id IS NOT NULL THEN
                    ...
                    VALUES (
                        ...
                        'Kitting', 
                        'Ready', -- Changed from Pending to Ready
                ...
                VALUES (
                    ...
                    p_service_opportunity_id, 
                    'Field', 
                    'Ready', -- Changed from Conditional to Ready
                    p_assigned_to, 
                    v_kitting_job_id,
                    jsonb_build_object(
                        'description', 'Perform ' || v_template_name,
                        'kitting_status', CASE WHEN v_kitting_job_id IS NOT NULL THEN 'Pending' ELSE 'N/A' END
                    )
                )
        ...
        conn.commit()
        print("✅ RPC generate_service_workflow updated successfully.")
