-- Update master_calendar view to exclude Dismissed and Cancelled service opportunities
-- This aligns the calendar visibility with the user's "Active" expectation
...
WHERE so.status NOT IN ('archived', 'Dismissed', 'Cancelled') AND so.deleted_at IS NULL;
