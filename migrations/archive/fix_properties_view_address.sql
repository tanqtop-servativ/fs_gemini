-- Fix Address Formatting in properties_enriched
-- Remove legacy concatenation of city/zip
...
SELECT 
    ...
    p.hcp_customer_id,
    p.hcp_address_id,
    p.address AS display_address, -- MODIFIED: Use raw address column without appending city/zip
    p.check_in_time,
    p.check_out_time,
    p.time_zone,
    p.is_dst,
